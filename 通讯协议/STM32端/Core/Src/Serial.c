...
//ROS2相关代码
void Pack_Data_ROS2(_send_packetinfo sendinfo,uint8_t* feedArray);//打包函数，需要和Data_Select结合使用
...
uint16_t Get_CRC16_Check_Sum(const uint8_t * pchMessage, uint32_t dwLength, uint16_t wCRC);//CRC校验码生成
